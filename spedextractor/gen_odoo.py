...
HEADER = """# Copyright 2025 - TODAY, Akretion - Raphael Valyi <raphael.valyi@akretion.com>
...
"""
    ...
    <field name="view_mode">tree,form</field>
        ...
        concrete_models_source = f"{HEADER}\n{IMPORTS}"
        last_bloco = None
        classes = []
        registers = list(
            sorted(
        ...
        for register in registers:
            ...
            if register["level"] > 1 or register["code"] == "0000":
                ...
                docstring = "\n    ".join(
                    generator.filters.format_docstring(
                        '"""' + register["short_desc"] + '."""', 1
                    ).splitlines()
                )
    ...
    <record id="%s_%s_action" model="ir.actions.act_window">
        ...
        path = Path(f"{base_path}/l10n_br_sped_{mod}/security/ir.model.access.csv")
