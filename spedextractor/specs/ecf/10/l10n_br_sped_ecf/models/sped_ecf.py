...
class Registro0000(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.0000"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "NOME_ESC": 0,  # Texto fixo contendo a identificação do tipo de Sped...
    #         "COD_VER": 0,  # Código da versão do leiaute. Observação: Para o ano-...
    #         "CNPJ": 0,  # Preencher este campo com o número de inscrição no Cadas...
    #         "NOME": 0,  # Nome empresarial da pessoa jurídica ou da Sociedade em ...
    #         "IND_SIT_INI_PER": 0,  # Indicador do Início do Período: 0 – Regular ...
    ...
    #         "DT_INI": 0,  # Data do Início do Período: Data inicial das informaçõ...
    #         "DT_FIN": 0,  # Data do Fim do Período: Data final das informações co...
    ...
    #         "COD_SCP": 0,  # CNPJ da SCP (ANEXOS I e VIII, da Instrução Normativa...
    #     }
...
class Registro0010(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.0010"
...
class Registro0020(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.0020"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "IND_ALIQ_CSLL": 0,  # PJ Sujeita à Alíquota da CSLL de 9%; 15% ou 20...
    ...
    #         "IND_PGTO_REM": 0,  # A Pagamentos ou Remessas a Título de Serviços, ...
    ...
    #         "IND_PJ_HAB": 0,  # a b c d PJ Habilitada ao Repes, Recap, Padis, Rei...
    ...
    #         "IND_PAIS_A_PAIS": 0,  # Entidade Integrante de Grupo Multinacional: ...
    #         "IND_DEREX": 0,  # Declaração sobre utilização dos recursos em moeda ...
    #         "IND_PR_TRANSF": 0,  # Opção pelas novas regras de preços de transfer...
    #     }
...
class Registro0021(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.0021"
    ...
    #         "IND_OLEO_BUNKER": 0,  # Regime de Suspensão de Óleo Bunker: S - Sim ...
    #         "IND_REPORTO": 0,  # Regime Tributário para o Incentivo à Modernizaçã...
    #         "IND_RET_II": 0,  # Regime Especial de Tributação Aplicável às Incorp...
    #         "IND_RET_PMCMV": 0,  # Regime Especial de Tributação Aplicável às Con...
    #         "IND_RET_EEI": 0,  # Regime Especial de Tributação Aplicável às Const...
    #         "IND_EBAS": 0,  # Entidade Beneficente de Assistência Social (EBAS): ...
    #         "IND_REPETRO_INDUSTRIALIZACAO": 0,  # Regime Especial de Industrializ...
    #         "IND_REPETRO_NACIONAL": 0,  # Regime Tributário e Aduaneiro Especial ...
    #         "IND_REPETRO_PERMANENTE": 0,  # Regime Tributário e Aduaneiro Especia...
    #         "IND_REPETRO_TEMPORARIO": 0,  # Regime Tributário e Aduaneiro Especia...
    #     }
...
class Registro0030(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.0030"
    ...
    #         "UF": 0,  # UF, conforme tabela do Sped (Disponibilizada no programa ...
...
class Registro0035(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.0035"
...
class Registro0930(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.0930"
...
class RegistroE010(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.e010"
...
class RegistroE015(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.e015"
...
class RegistroE020(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.e020"
...
class RegistroE030(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.e030"
...
class RegistroE155(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.e155"
...
class RegistroE355(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.e355"
...
class RegistroJ050(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.j050"
...
class RegistroJ051(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.j051"
...
class RegistroJ053(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.j053"
...
class RegistroJ100(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.j100"
...
class RegistroK030(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.k030"
...
class RegistroK155(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.k155"
...
class RegistroK156(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.k156"
...
class RegistroK355(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.k355"
...
class RegistroK356(models.Model):
    """Mapeamento Referencial dos Saldos Finais das Contas de Resultado Antes do
    Encerramento."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.k356"
    _inherit = "l10n_br_sped.ecf.10.k356"
...
class RegistroK915(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.k915"
...
class RegistroK935(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.k935"
...
class RegistroL030(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.l030"
...
class RegistroL100(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.l100"
...
class RegistroL200(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.l200"
...
class RegistroL210(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.l210"
...
class RegistroL300(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.l300"
...
class RegistroM010(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m010"
...
class RegistroM030(models.Model):
    """Identificação do Período e Forma de Apuração do IRPJ e da CSLL das Empresas
    Tributadas."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.m030"
    _inherit = "l10n_br_sped.ecf.10.m030"
...
class RegistroM300(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m300"
...
class RegistroM305(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m305"
...
class RegistroM310(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m310"
...
class RegistroM312(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m312"
...
class RegistroM315(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m315"
...
class RegistroM350(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m350"
...
class RegistroM355(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m355"
...
class RegistroM360(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m360"
...
class RegistroM362(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m362"
...
class RegistroM365(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m365"
...
class RegistroM410(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m410"
...
class RegistroM415(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m415"
...
class RegistroM500(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m500"
...
class RegistroM510(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.m510"
...
class RegistroN030(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n030"
...
class RegistroN500(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n500"
...
class RegistroN600(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n600"
...
class RegistroN605(models.Model):
    """Contas Contábeis Envolvidas na Apuração do Lucro da Exploração."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.n605"
    _inherit = "l10n_br_sped.ecf.10.n605"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "COD_CTA": 0,  # Código da conta contábil. Observação: código da cont...
    #         "COD_CCUS": 0,  # Código do centro de custos. Observação: código do c...
    #         "VALOR": 0,  # Saldo utilizado.
    #         "IND_VALOR": 0,  # Indicador do saldo utilizado: D – Devedor C – Cred...
    #     }
...
class RegistroN610(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n610"
...
class RegistroN615(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n615"
...
class RegistroN620(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n620"
...
class RegistroN630(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n630"
...
class RegistroN650(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n650"
...
class RegistroN660(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n660"
...
class RegistroN670(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.n670"
...
class RegistroP030(models.Model):
    """Identificação dos Períodos e Forma de Apuração do IRPJ e da CSLL das Empresas
    Tributadas."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.p030"
    _inherit = "l10n_br_sped.ecf.10.p030"
...
class RegistroP100(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.p100"
...
class RegistroP130(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.p130"
...
class RegistroP150(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.p150"
...
class RegistroP200(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.p200"
...
class RegistroP230(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.p230"
...
class RegistroP300(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.p300"
...
class RegistroP400(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.p400"
...
class RegistroP500(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.p500"
...
class RegistroQ100(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.q100"
...
class RegistroT030(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.t030"
...
class RegistroT120(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.t120"
...
class RegistroT150(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.t150"
...
class RegistroT170(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.t170"
...
class RegistroT181(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.t181"
...
class RegistroU030(models.Model):
    """Identificação dos Períodos e Formas de Apuração do IPRJ e da CSLL das Empresas
    Imunes e Isentas."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.u030"
    _inherit = "l10n_br_sped.ecf.10.u030"
...
class RegistroU100(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.u100"
...
class RegistroU150(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.u150"
...
class RegistroU180(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.u180"
...
class RegistroU182(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.u182"
...
class RegistroV010(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.v010"
...
class RegistroV020(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.v020"
...
class RegistroV030(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.v030"
...
class RegistroV100(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.v100"
...
class RegistroW100(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.w100"
...
class RegistroW200(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.w200"
...
class RegistroW250(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.w250"
...
class RegistroW300(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.w300"
...
class RegistroX280(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x280"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "IND_ATIV": 0,  # Benefício fiscal: 00 – Não preenchido 01 – Isenção ...
    #         "IND_CONCEDENTE": 0,  # A Órgão Concessor da Isenção/Redução: M: Suda...
...
class RegistroX292(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x292"
...
class RegistroX340(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x340"
...
class RegistroX350(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x350"
...
class RegistroX351(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x351"
...
class RegistroX352(models.Model):
    """Demonstrativo de Resultados no Exterior Auferidos por Intermédio de Coligada."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.x352"
    _inherit = "l10n_br_sped.ecf.10.x352"
...
class RegistroX353(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x353"
...
class RegistroX354(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x354"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "RES_NEG": 0,  # Resultado Negativo de Períodos Anteriores em Moeda d...
    #         "RES_NEG_REAL": 0,  # Resultado Negativo de Períodos Anteriores em Re...
...
class RegistroX355(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x355"
...
class RegistroX356(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x356"
...
class RegistroX357(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x357"
...
class RegistroX360(models.Model):
    """Informações Gerais sobre Preços de Transferência."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.x360"
    _inherit = "l10n_br_sped.ecf.10.x360"
...
class RegistroX365(models.Model):
    """Informações Sobre Contrapartes nas Transações Controladas."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.x365"
    _inherit = "l10n_br_sped.ecf.10.x365"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "IDENTIFICADOR": 0,  # Código da entidade (definido pela própria empr...
    #         "NOME_ENT": 0,  # Nome da Entidade
    #     }


class RegistroX366(models.Model):
    """Entidades Com as Quais Realiza Transações Controladas."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.x366"
    _inherit = "l10n_br_sped.ecf.10.x366"
...
class RegistroX370(models.Model):
    """Informações Sobre as Transações Controladas."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.x370"
    _inherit = "l10n_br_sped.ecf.10.x370"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "IDENTIFICADOR": 0,  # Identificador da entidade com a qual o contrib...
    #         "TIPO_TRANSACAO": 0,  # Código do tipo de transação: 01 - Exportações...
    #         "NOME_ENT": 0,  # Nome da entidade com a qual o contribuinte realizou...
    #         "PAIS": 0,  # País de residência da entidade com a qual o contribuint...
    #         "COD_NCM": 0,  # Nomenclatura Comum do Mercosul (NCM) dos bens export...
    #         "TIPO_DEMAIS": 0,  # Tipo de Serviço, Direito, Operações Financeiros,...
    #         "DESCR_BSDI": 0,  # Descrição da transação controlada.
    #         "VL_TRANSACAO": 0,  # Valor da transação controlada.
    #         "IND_AJUSTES": 0,  # Houve ajustes em função das regras de preços de ...
    #         "VL_ESPONTANEO": 0,  # Valor do ajuste espontâneo.
    #         "VL_COMPENSATORIO": 0,  # Valor do ajuste compensatório.
    #         "TIP_AJ_COMPENSATORIO": 0,  # 0 Tipo de ajuste compensatório: 1 – Aum...
    #         "METODO": 0,  # P Método de preços de transferência utilizado: IC – P...
    #         "DESCRICAO": 0,  # Descrição do método de preços de transferência uti...
    #         "COMP_INTENCIONAL": 0,  # Houve compensações intencionais (art. 27 da...
    #         "SINERGIA": 0,  # Houve efeitos de sinergia (art. 31 da IN RFB nº 2.1...
    #         "IND_TRANS_COMBINADAS": 0,  # A transação foi avaliada combinadamente...
    #         "IND_DADOS_MULTIP": 0,  # Houve utilização de dados de múltiplos anos...
    #         "IND_SIMPLIFIC": 0,  # O O contribuinte adotou a medida de simplifica...
    #     }


class RegistroX371(models.Model):
    """Informações Sobre Ajustes Compensatórios."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.x371"
    _inherit = "l10n_br_sped.ecf.10.x371"
    ...
    #         "COD_CCUS": 0,  # Código do centro de custos
    #         "VALOR": 0,  # Saldo utilizado
    #         "IND_VALOR": 0,  # D Indicador de saldo utilizado: – Devedor C – Cred...
    #     }


class RegistroX375(models.Model):
    """Informações Relacionadas ao Método de Preços de Transferência."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.x375"
    _inherit = "l10n_br_sped.ecf.10.x375"
...
class RegistroX390(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x390"
...
class RegistroX400(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x400"
...
class RegistroX410(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x410"
...
class RegistroX420(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x420"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "TIP_ROY": 0,  # Indicar se são royalties recebidos ou pagos a benefi...
...
class RegistroX430(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x430"
...
class RegistroX450(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x450"
...
class RegistroX451(models.Model):
    """Pagamentos ou Remessas Relativos a Serviços."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.x451"
    _inherit = "l10n_br_sped.ecf.10.x451"
...
class RegistroX460(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x460"
...
class RegistroX470(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x470"
...
class RegistroX480(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x480"
...
class RegistroX485(models.Model):
    """Benefícios Fiscais – Parte II."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.x485"
    _inherit = "l10n_br_sped.ecf.10.x485"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "TIPO_BENEF": 0,  # Tipo do Benefício: 1 – REPES 2 – RECAP 3 – PADIS ...
    #         "ATO_DECL": 0,  # N Número do Ato Declaratório: úmero do Ato Declarat...
    #         "CNPJ_INCORP": 0,  # Inscrição da “Incorporação Afetada” no Cadastro ...
    #         "ID_OBRA_2018": 0,  # S Identificação da Obra/Construção - CONTRATO F...
    #         "ID_OBRA_2020": 0,  # S Identificação da Obra/Construção - CONTRATO F...
    #         "ID_OBRA_EEI": 0,  # Identificação da Obra/Construção. Somente preenc...
    #         "PORT_CEBAS": 0,  # Número da Portaria que concedeu o CEBAS Atual Núm...
    #         "DT_DOU_PORT_CEBAS": 0,  # Data da Publicação da Portaria que concede...
    #         "DT_INI_PORT_CEBAS": 0,  # Data de Início de Vigência da Portaria que...
    #         "DT_FIN_PORT_CEBAS": 0,  # Data de Fim de Vigência da Portaria que co...
    #     }
...
class RegistroX490(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x490"
...
class RegistroX500(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x500"
...
class RegistroX510(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.x510"
...
class RegistroY520(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y520"
...
class RegistroY570(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y570"
...
class RegistroY590(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y590"
...
class RegistroY600(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y600"
...
class RegistroY612(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y612"
...
class RegistroY620(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y620"
...
class RegistroY630(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y630"
...
class RegistroY640(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y640"
...
class RegistroY650(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y650"
...
class RegistroY660(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y660"
...
class RegistroY672(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y672"
...
class RegistroY680(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y680"
...
class RegistroY681(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y681"
...
class RegistroY682(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y682"
...
class RegistroY720(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y720"
...
class RegistroY750(models.Model):
    """Informações da ECF Calculadas pelo PGE."""

    _description = textwrap.dedent(f"    {__doc__}")
    _name = "l10n_br_sped.ecf.y750"
    _inherit = "l10n_br_sped.ecf.10.y750"
...
class RegistroY800(models.Model):
    ...
    _inherit = "l10n_br_sped.ecf.10.y800"

    # @api.model
    # def _map_from_odoo(self, record, parent_record, declaration, index=0):
    #     return {
    #         "TIPO_DOC": 0,  # Tipo do Documento: 001 - Memória de Cálculo - Incor...
