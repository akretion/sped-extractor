...
class Registro0000(models.AbstractModel):
    ...
    COD_VER = fields.Char(
        ...
        sped_length="4",
        help=(
            "Código da versão do leiaute. Observação: Para o ano-calendário 2021 e "
            "situações especiais de 2022, o leiaute é o 0008."
        ),
    )
    ...
    IND_SIT_INI_PER = fields.Char(
        ...
        help=(
            ...
            "Resultante de cisão/fusão ou remanescente de cisão, ou realizou "
            "incorporação. 3 – Resultante de Mudança de Qualificação da Pessoa "
            "Jurídica. 4 – Início de obrigatoriedade da entrega no curso do ano "
            "calendário. (Exemplo: Exclusão do Simples Nacional ou desenquadramento "
            "como imune ou isenta do IRPJ)"
        ),
    )
    ...
    RETIFICADORA = fields.Char(
        ...
        help=(
            ...
            "tributação (Art. 6º-A, § 2º, da Instrução Normativa RFB nº 1.422/2013). A "
    ...
    NUM_REC = fields.Char(
        ...
        help=(
            ...
            "preenchido com o número constante no recibo de entrega da última ECF "
            "transmitida, nos casos de 0000.RETIFICADORA = “S” ou “F”."
        ),
    )
    ...
    COD_SCP = fields.Char(
        ...
        sped_length="14",
        help=(
            "CNPJ da SCP (Art. 4º, XVII, da Instrução Normativa RFB nº 1.634, de 6 de "
            "maio de 2016). Observação: Só deve ser preenchido pela própria SCP (Não é "
            "preenchido pelo sócio ostensivo)."
        ),
    )
...
class Registro0010(models.AbstractModel):
    ...
    FORMA_TRIB = fields.Integer(
        ...
        help=(
            ...
            "Presumido/Real. 4 – Lucro Presumido/Real/Arbitrado. 5 – Lucro Presumido."
        ),
    )
    ...
    IND_REC_RECEITA = fields.Char(
        ...
        help=(
            ...
            "Regime de caixa 2. Regime de competência"
        ),
    )
...
class Registro0020(models.AbstractModel):
    ...
    IND_ALIQ_CSLL = fields.Char(
        ...
        sped_length="1",
        help=(
            "PJ Sujeita à Alíquota da CSLL de 9% ou 15% ou 20%: 1 – Alíquota de 9% 5 – "
            "Alíquota de 20%-25% 6 – Alíquota de 15%-20%"
        ),
    )
    ...
    IND_OP_VINC = fields.Char(
        ...
        help=(
            ...
            "Lei nº 11.727, de 2008). Deve também assinalar este campo a pessoa "
            "jurídica, inclusive instituição financeira ou companhia seguradora, que "
            "realizar as operações acima referidas por intermédio de interposta pessoa."
        ),
    )
    ...
    IND_PJ_HAB = fields.Char(
        ...
        sped_length="1",
        help=(
            "PJ Habilitada no Repes, Recap, Padis, PATVD, Reidi, Repenec, Reicomp, "
            "Retaero, Recine, Resíduos Sólidos, Recopa, Copa do Mundo, Retid, REPNBL-"
            "Redes, Reif e Olimpíadas: S – Sim N – Não A pessoa jurídica habilitada no "
            "Regime Especial de Tributação para a Plataforma de Exportação de Serviços "
            "de Tecnologia da Informação (Repes) ou no Regime Especial de Aquisição de "
            "Bens de Capital para Empresas Exportadoras (Recap) instituídos pela Lei nº"
            " 11.196, de 2005, regulamentados pelos Decretos nº 5.712, de 2 de março de"
            " 2006, e nº 5.649, de 29 de dezembro de 2005, respectivamente, deve "
            "assinalar este campo. Também deve assinalar este campo a pessoa jurídica "
            ...
            "Equipamentos para TV Digital (PATVD), instituídos pela Lei nº 11.484, de "
            "2007. Este campo deve também ser assinalado pela pessoa jurídica "
            "habilitada ou co-habilitada no Regime Especial de Incentivos e "
            "Desenvolvimento da Infraestrutura (Reidi), instituído pela Lei nº 11.488, "
            "de 15 de junho de 2007, e regulamentado pelo Decreto nº 6.144, de 3 de "
            "julho de 2007, com alterações introduzidas pelo Decreto nº 6.167, de 24 de"
            " julho de 2007. Habilitada ou co-habilitada no Regime Especial de "
            "Incentivos para o Desenvolvimento da Infraestrutura da Indústria "
            "Petrolífera das Regiões Norte, Nordeste e Centro-Oeste (Repenec), "
            "instituído pela Lei nº 12.249, de 2010, regulamentado pelo Decreto nº "
            "7.320, de 28 de setembro de 2010. Habilitada no Regime Especial de "
            "Incentivo a Computadores para Uso Educacional (REICOMP), instituído pela "
            "Lei nº 12.715, de 17 de setembro de 2012. Habilitada no Regime Especial "
    ...
    IND_PAIS_A_PAIS = fields.Char(
        ...
        sped_length="1",
        help=(
            "Enditdade Integrante de Grupo Multinacional: A pessoa jurídica é entidade "
...
class Registro0021(models.AbstractModel):
    ...
    IND_RETAERO = fields.Char(
        ...
        sped_length="1",
        help=(
            "Regime Especial para a Indústria Aeronáutica Brasileira (Retaero): S - Sim"
            " N – Não"
        ),
    )
    ...
    IND_RESIDUOS_SOLIDOS = fields.Char(
        ...
        sped_length="1",
        help=(
            "Estabelecimentos industriais façam jus a crédito presumido do IPI na "
            "aquisição de resíduos sólidos, de que trata a Lei nº 12.375, de 30 de "
            "dezembro de 2010: S - Sim N – Não"
        ),
    )
    ...
    IND_RECOPA = fields.Char(
        ...
        help=(
            ...
            "modernização de estádios de futebol (Recopa): S - Sim N – Não"
        ),
    )
    ...
    IND_COPA_DO_MUNDO = fields.Char(
        ...
        sped_length="1",
        help=(
            "Habilitada para fins de fruição dos benefícios fiscais, não abrangidos na "
            "alínea anterior, relativos à realização, no Brasil, da Copa das "
            "Confederações FIFA 2013 e da Copa do Mundo FIFA 2014, de que trata a Lei "
            "nº 12.350, de 2010, regulamentada pelo Decreto nº 7.578, e 11 de outubro "
            "de 2011: S - Sim N - Não"
        ),
    )
    ...
    IND_REPNBL_REDES = fields.Char(
        ...
        help=(
            ...
            "Implantação de Redes de Telecomunicações (REPNBL-Redes): S - Sim N - Não"
        ),
    )
    ...
    IND_REIF = fields.Char(
        ...
        help=(
            ...
            "Indústria de Fertilizantes (REIF): S - Sim N - Não"
        ),
    )
    ...
    IND_OLIMPIADAS = fields.Char(
        ...
        sped_length="1",
        help=(
            "Habilitada para fins de fruição dos benefícios fiscais, relativos à "
            "realização, no Brasil, dos Jogos Olímpicos de 2016 e dos Jogos "
            "Paraolímpicos de 2016, de que trata a Lei nº 12.780, de 2013: S - Sim N - "
            "Não"
        ),
    )
...
class Registro0030(models.AbstractModel):
    ...
    UF = fields.Char(
        ...
        sped_length="2",
        help=(
            "UF, conforme do tabela do Sped (Disponibilizada no programa da ECF no "
...
class RegistroM010(models.AbstractModel):
    ...
    COD_PB_RFB = fields.Char(
        ...
        help=(
            ...
            "arquivo “Tabelas_Dinamicas_ECF_Leiaute_8_AC2021_SIT_ESP_2022.xlsx” a "
            "partir do linkhttp://sped.rfb.gov.br/pasta/show/1644. s relacionamentos "
...
class RegistroX280(models.AbstractModel):
    ...
    IND_ATIV = fields.Char(
        ...
        help=(
            ...
            "Reinvestimento Selecionar no campo Benefício Fiscal o tipo de benefício "
            "(isenção ou redução do IRPJ) em relação a cada projeto aprovado no órgão "
            "competente, conforme lista disponível na Caixa de Combinação. E, para cada"
            " projeto aprovado selecionar no campo Projeto se o mesmo corresponde a "
            "'Novo Empreendimento', 'Modernização', 'Ampliação', 'Diversificação', "
            "'Manutenção de Empreendimento', 'Prouni', “Padis” ou “Outros”. I) Isenção:"
            " Este tipo de benefício deve ser selecionado pela pessoa jurídica: a) que "
            "tenha instalado, ampliado, modernizado ou diversificado empreendimento "
            "industrial ou agrícola, nas áreas de atuação da Sudam e da Sudene, até 31 "
            "de dezembro de 1997, nos termos da MP nº 1.740-32, de 1999, convalidada "
            "pela Lei nº 9.808, de 1999, art. 13; b) que tenham empreendimento "
            "industrial ou agrícola decorrente de projeto aprovado ou protocolizado até"
            " 14 de novembro de 1997 nas áreas de atuação da Sudam e da Sudene."
        ),
    )
    ...
    IND_CONCEDENTE = fields.Char(
        ...
        sped_length="2",
        help=(
            "A Orgão Concessor da Isenção/Redução: M: Sudam – Superintendência de "
...
class RegistroX300(models.AbstractModel):
    ...
    TIP_EXP = fields.Char(
        ...
        sped_length="2",
        help=(
            "Tipo das Exportações: 01 - Bens 02 - Serviços 03 - Direitos 04 - Operações"
            " Financeiras 05 - Não Especificadas"
        ),
    )
    ...
    DESC_EXP = fields.Char(
        ...
        help=(
            "Descrição das Exportações: Agrupar os bens, serviços ou direitos de mesma "
            "natureza, descrevendo cada grupo de modo a permitir a sua perfeita "
            "identificação e informando elementos como marca, tipo, modelo, espécie, "
            "etc. Atenção: no caso de bens considerados commodities, sujeitos à "
            "aplicação do método PECEX, deverá ser efetuado um Registro X300 para cada "
            "transação realizada, mesmo quando houver mais de uma transação envolvendo "
            "o mesmo bem. Obrigatório somente quando TIP_EXP = Bens, Serviços ou "
            "Direitos"
        ),
    )
    ...
    TOT_OPER = fields.Float(
        ...
        help=(
            "Total das Operações: EXPORTAÇÕES – Bens, Serviços ou Direito Informar, em "
            "reais, para cada operação incluída o valor correspondente ao total de "
            "transações da mesma natureza realizadas durante o ano-calendário. São "
            "consideradas transações de mesma natureza aquelas cujos bens, serviços ou "
            "direitos negociados apresentem as mesmas especificações no campo "
            "'Descrição'. Atenção: no caso de bens considerados commodities, sujeitos à"
            " aplicação do método PECEX, deve ser informado o valor de cada transação "
            "realizada, mesmo quando houver mais de uma transação envolvendo o mesmo "
            "bem. EXPORTAÇÕES – Não Especificadas Informar neste campo o somatório das "
            "operações não informadas nos campos referentes às maiores operações ou, se"
            " for o caso, a soma do valor excedente a pelo menos 80% do total das "
            "exportações, especificadas em X300.TIP_EXP como “01”, “02”, “03” ou “04”, "
            "efetuadas no ano-calendário. Obrigatório quando TIP_EXP = Bens, Serviços, "
            "Direitos ou Não Especificadas."
        ),
    )
    ...
    COD_NCM = fields.Char(
        ...
        sped_length="8",
        help=(
            "Código NCM constante do respectivo registro de exportação, quando o tipo "
            "de operação for 'Bens'. Obrigatório somente quando TIP_EXP = Bens"
        ),
    )
    ...
    QTDE = fields.Float(
        ...
        help=(
            ...
            "natureza exportados (no caso de transações envolvendo commodities, o total"
            " de bens exportados em cada transação realizada). Obrigatório somente "
            "quando TIP_EXP = Bens"
        ),
    )
    ...
    UNI_MED = fields.Char(
        ...
        sped_length="2",
        help=(
            "Unidade de Medida: Obrigatório somente quando TIP_EXP = Bens Conforme "
            "tabela de unidades de medida do Sped. A pessoa jurídica deve selecionar "
            "dentre as opções aquela que corresponde à unidade de medida comercial dos "
            "bens exportados, tais como: dúzia, grama, litro, metro etc."
        ),
    )
    ...
    IND_OPER = fields.Char(
        ...
        sped_length="1",
        help=(
            "Indicador de Operação Sujeita a Arbitramento S - Sim N - Não Obrigatório "
            "somente quando TIP_EXP = Bens, Serviços ou Direitos O campo deve ser "
            "assinalado caso o preço médio de venda do bem, serviço ou direito das "
            "exportações efetuadas durante o respectivo período de apuração da base de "
            "cálculo do imposto de renda seja inferior a noventa por cento do preço "
            "médio praticado na venda dos bens, serviços ou direitos, idênticos ou "
            "similares, no mercado brasileiro, durante o mesmo período, em condições de"
            " pagamento semelhantes (art. 20 da Instrução Normativa RFB nº 1.312, de 28"
            " de dezembro de 2012). Atenção: Caso a pessoa jurídica não efetue "
            "operações de venda no mercado interno, a determinação dos preços médios é "
            "efetuada com dados de outras empresas que pratiquem a venda de bens, "
            "serviços ou direitos, idênticos ou similares, no mercado brasileiro (§ 2º,"
            " art. 20 da Instrução Normativa RFB nº 1.312, de 28 de dezembro de 2012)."
        ),
    )
    ...
    TIP_MET = fields.Char(
        ...
        sped_length="5",
        help=(
            "A pessoa jurídica deve assinalar o método utilizado na determinação do "
            "'Preço Parâmetro': PVEX - Método do Preço de Venda nas Exportações (inciso"
            " I do § 3º do art. 19 da Lei nº 9.430, de 1996); PVA - Método do Preço de "
            "Venda por Atacado no País de Destino, Diminuído do Lucro (inciso II do § "
            "3º do art. 19 da Lei nº 9.430, de 1996); PVV - Método do Preço de Venda a "
            "Varejo no País de Destino, Diminuído do Lucro (inciso III do § 3º do art. "
            "19 da Lei nº 9.430, de 1996); CAP - Método do Custo de Aquisição ou de "
            "Produção mais Tributos e Lucro (inciso IV do § 3º da Lei nº 9.430, de "
            "1996). PECEX - Preço sob Cotação na Exportação (Art. 19-A da Lei nº 9.430,"
            " de 1996, e art. 34 da IN RFB nº 1.312, de 28 de dezembro de 2012)."
        ),
    )
    ...
    OPER_PAR = fields.Char(
        ...
        sped_length="1",
        help=(
            "Operações Parâmetro: Informar que tipo de operações foram selecionadas "
            "para a apuração do preço parâmetro, dentre as seguintes opções (art. 30 da"
            " Instrução Normativa RFB nº 1.312/2012): A – Operações realizadas entre a "
            "própria pessoa jurídica e outros clientes não vinculados. B – Operações "
            "realizadas entre outro exportador nacional e clientes não vinculados."
        ),
    )
    ...
    DESC_BENS_PAR = fields.Char(
        ...
        help=(
            ...
            "selecionados para o cálculo do preço parâmetro nas operações de exportação"
            " utilizadas e informadas no campo X300.OPER_PAR."
        ),
    )
    ...
    ID_PARTE_PAR = fields.Char(
        ...
        help=(
            "Identificação das partes envolvidas nas operações de exportação utilizadas"
            " e informadas no campo X300.OPER_PAR (informar nome, razão social e número"
            " de identificação)."
        ),
    )
    ...
    TIP_PAR = fields.Char(
        ...
        sped_length="1",
        help=(
            "Tipo dos Itens para o Cálculo do Preço Parâmetro: Informar o tipo do bem, "
            "serviço ou direito utilizado para fins de apuração do preço parâmetro, "
            "dentre as seguintes opções: I – Idêntico S – Similar"
        ),
    )
    ...
    DAT_UTIL = fields.Date(
        ...
        help=(
            ...
            "utilizada para o cálculo do preço parâmetro, podendo ser a data da "
            "transação (conforme dispõe o § 2º-A, art 34, da Instrução Normativa RFB nº"
            " 1312/2012). Escolher entre as seguintes opções: – Data da Transação O - "
            "Data da Transação (art. 34, §17) E – Data do Embarque Caso escolhida a "
            "opção 'T - Data da Transação', deverá ser informado no campo 18 "
            "'X300.DAT_TRANS' a data em que o preço foi negociado, conforme art. 34, "
            "§16 da Instrução Normativa RFB 1.312/2012. opção 'O - Data da Transação "
            "(art. 34, §17) deve ser escolhida caso o contribuinte utilize cotações ou "
            "índices relativos a uma média de dias, conforme dispõe o art. 34, §17 da "
    ...
    CRIT_PAR = fields.Char(
        ...
        help=(
            "Critérios para Determinação do Preço Parâmetro: Descrever a metodologia e "
            "os critérios utilizados para fixação do preço, relatando, inclusive, a "
            "existência de diferenças entre a data em que a operação foi contratada e "
            "aquela em que o preço foi estabelecido. Na hipótese em que o preço seja "
            "fixado com base em cotações ou índices relativos a uma média de dias, "
            "descrever o critério utilizado."
        ),
    )
    ...
    DAT_TRANS = fields.Date(
        ...
        sped_length="8",
        help=(
            "Data da Transação: Informar a data em que o preço foi negociado (conforme "
            "art. 34, §16 da Instrução Normativa RFB 1.312/2012)."
        ),
    )
    ...
    DAT_EMB = fields.Date(
        ...
        xsd_type="numeric_code",
        sped_length="8",
        help="Data do Embarque: Informar a data do embarque da commodity negociada.",
    )
    ...
    ID_FONT_COT = fields.Char(
        ...
        sped_length="3",
        help=(
            "1 Fonte da Cotação: Identificação da fonte da cotação utilizada para a o "
            "cálculo do preço parâmetro informado em X300.VL_PAR (indicação da bolsa de"
            " mercadorias e futuros utilizada, dentre as listadas no Anexo II da "
            "Instrução Normativa RFB nº 1.312/2012; ou da instituição de pesquisa "
            "setorial, dentre as listadas no Anexo III da referida Instrução Normativa;"
            " ou da utilização de preços definidos por agências ou órgãos reguladores, "
            "conforme art. 36, inciso II da Instrução Normativa RFB nº 1.312/2012). 01 "
            "ChicagoBoard of Trade (CBOT) - Chicago - EUA; 102 Chicago Mercantile "
            "Exchange (CME) - Chicago - EUA; 103 New York Mercantile Exchange (NYMEX) -"
            " Nova York - EUA; 104 Commodity Exchange (COMEX) - Nova York - EUA; 105 "
            "Intercontinental Exchange (ICE US) - Atlanta - EUA; 106 Bolsa de "
            "Mercadorias & Futuros (BM&F) - São Paulo - Brasil; 107 Life NYSE Euronext "
            "(LIFFE) - Londres - Reino Unido; 108 London Metal Exchange (LME) - Londres"
            " - Reino Unido; 109 Intercontinental Exchange (ICE Europe) - Londres - "
            "Reino Unido; 110 Tokio Commodity Exchange (TOCOM) - Tóquio - Japão; 111 "
            "Tokio Grain Exchange (TGE) - Tóquio - Japão; 112 Singapore Commodity "
            "Exchange (SICOM) - Cidade de Cingapura - Cingapura; 113 Hong Kong "
            "Commodity Exchange (HKE) - Hong Kong – China; 114 Multi Commodity Exchange"
            " (MCX) - Bombain - Índia; 115 National Commodity & Derivatives Exchange "
            "Limited (NCDEX) - Bombain - Índia; 116 Agricultural Futures Exchange of "
            "Thailand (AFET) - Bangkok - Tailândia; 117 Australian Securities Exchange "
            "(ASX) - Sidney - Austrália; 118 JSE Safex APD (SAFEX) – Johannesburg - "
            "África do Sul; 119 Korea Exchange (KRX) - Busan - Coréia do Sul; 120 China"
            " Beijing International Mining Exchange, (CBMX);"
        ),
    )
    ...
    AJ_PAR = fields.Char(
        ...
        sped_length="1",
        help=(
            "Ajustes ao Preço Parâmetro: Informar se foram realizados ajustes ao preço "
            "parâmetro, conforme disposto nos arts. 22 a 25 e no art. 34, §§7º e 10 da "
            "Instrução Normativa RFB nº 1.312/2012, a depender do método aplicado. S = "
            "Sim N = Não"
        ),
    )
    ...
    VL_PAR = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Preço Parâmetro: A pessoa jurídica deve informar neste campo o preço "
            "parâmetro médio ponderado de vendas nas exportações dos bens, serviços ou "
            "direitos, apurado no ano- calendário conforme os métodos estabelecidos nos"
            " arts. 30 a 34 da Instrução Normativa RFB nº 1.312, de 28 de dezembro de "
            "2012. Atenção: nos casos de utilização do método PECEX, o valor a ser "
            "informado é o preço parâmetro apurado para cada transação realizada. "
    ...
    VL_PRAT = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Preço Praticado: A pessoa jurídica deve informar neste campo o preço "
            "praticado médio ponderado de venda nas exportações dos bens, serviços ou "
            "direitos, praticado no ano- calendário. Atenção: nos casos de utilização "
            "do método PECEX, o valor a ser informado é o preço praticado em cada "
            "transação realizada. Obrigatório somente quando TIP_EXP = Bens, Serviços "
            "ou Direitos."
        ),
    )
    ...
    QTDE_AJ = fields.Float(
        ...
        help=(
            "O Quantidade Ajustada no Período de Apuração: Informar neste campo a "
            "quantidade de itens da mesma natureza exportados para pessoas vinculadas "
            "que resultaram em ajustes de preços de transferência adicionados à base de"
            " cálculo do IRPJ e da CSLL no período de apuração. Ou seja, a quantidade "
            "de bens ou insumos para os quais se verificou a necessidade de ajuste de "
            "preços de transferência após a aplicação de um dos métodos previstos na "
            "legislação para o cálculo do preço parâmetro e sua comparação com o preço "
            "praticado. brigatório somente quando TIP_EXP = Bens"
        ),
    )
    ...
    VL_AJ = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "E E O E Valor do Ajuste a Ser Adicionado: Valor do ajuste, determinado "
            "conforme os métodos da IN RFB nº 1.312/2012, a ser adicionado à base de "
            "cálculo do IRPJ e da CSLL. XPORTAÇÕES – Bens, Serviços ou Direitos A "
            "pessoa jurídica deverá indicar o valor do ajuste, determinado em "
            "conformidade com os arts. 26 a 29 da Instrução Normativa RFB nº 1.312, de "
            "28 de dezembro de 2012. A parcela das receitas de exportações provenientes"
            " de pessoas vinculadas, calculada com base nos métodos dispostos da IN "
            "1.312/12, que exceder os valores já apropriados na escrituração da empresa"
            " deve ser adicionada ao lucro líquido, para determinação do lucro real e "
            "da base de cálculo da contribuição social sobre o lucro líquido, bem como "
            "ser computada na determinação do lucro presumido ou arbitrado. XPORTAÇÕES "
            "– Financeiras A pessoa jurídica deve indicar o valor do ajuste, "
            "determinado em conformidade com o art. 38- A da Instrução Normativa RFB nº"
            " 1.312, de 28 de dezembro de 2012. s ajustes devem ser oferecidos à "
            "tributação de acordo com o regime fiscal a que se submete cada pessoa "
            "jurídica. XPORTAÇÕES – Não Especificadas A pessoa jurídica deve indicar o "
            "somatório dos ajustes efetuados, referente ao total das transações "
            "consolidadas no campo 'Total da Operação', agrupadas e informadas como "
            "“Não Especificadas” no campo ”Tipo das Exportações' ."
        ),
    )
    ...
    VALOR_COT = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "V alor da Cotação: Valor médio diário da cotação do bem ou direito "
            "exportado (art. 34 da Instrução Normativa RFB nº 1.312/2012) utilizada no "
            "cálculo do preço parâmetro, sem a inclusão de eventuais ajustes efetuados,"
            " em reais, e na mesma unidade de medida utilizada no preço praticado."
        ),
    )
    ...
    VL_JUR = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Juros: Informar em reais o valor total dos juros auferidos em operações "
            "financeiras durante o ano- calendário. Esse valor total deve ser "
            "consolidado consoante os códigos de natureza-fato de operação constantes "
            "da Consolidação das Normas Cambiais (CNC), editada pelo Banco Central do "
            "Brasil. Atenção: A pessoa jurídica financeira e seguradora deve informar "
            "neste campo o montante total dos juros auferidos em operações financeiras "
            "com pessoas vinculadas, inclusive por intermédio de interposta pessoa ou "
            "de pessoas residentes ou domiciliadas em países com tributação favorecida "
            "ou cuja legislação interna oponha sigilo, ou, a partir de 1º de janeiro de"
    ...
    VL_JUR_MIN = fields.Float(
        ...
        help=(
            "Taxa de Juros Mínima: Informar neste campo a menor taxa praticada em "
            "operação financeira, realizada no ano-calendário. Obrigatório apenas para "
    ...
    VL_JUR_MAX = fields.Float(
        ...
        help=(
            "Taxa de Juros Máxima: Informar neste campo a maior taxa praticada em "
            "operação financeira, realizada no ano-calendário. Obrigatório apenas para "
            "TIP_EXP=Operações Financeiras"
        ),
    )
    ...
    COD_CNC = fields.Char(
        ...
        sped_length="5",
        help=(
            "Código CNC, conforme tabela do Sped (Disponibilizada no programa da ECF no"
            " diretório Arquivos de Programas/Programas "
            "Sped/ECf/SpedEcf/Recursos/Tabelas). A pessoa jurídica deve informar, "
            "dentre os códigos de natureza-fato transcritos da rubrica Rendas de "
            "Capitais do Capítulo 1, Título 14 ou Capítulo 2, Título 22 da Consolidação"
            " das Normas Cambiais (CNC), aquele sob o qual se classificariam os juros "
            "auferidos para fins da legislação cambial - na hipótese de ingresso no "
            "País. Atenção: No caso de recursos não ingressados no País, o "
            "enquadramento se faz, consoante apuração contábil, como se ingressados "
            "fossem. Tendo ocorrido a efetiva entrada, esses valores são de igual modo "
            "classificados, independentemente do instrumento de formalização cambial "
            "utilizado no Banco Central do Brasil: contrato de câmbio (moeda "
            "estrangeira) e/ou transferência internacional em moeda nacional."
        ),
    )
    ...
    TIP_MOEDA = fields.Char(
        ...
        sped_length="3",
        help=(
            "Moeda , conforme tabela do Sped (Disponibilizada no programa da ECF no "
            "diretório Arquivos de Programas/Programas "
            "Sped/ECf/SpedEcf/Recursos/Tabelas)."
        ),
    )
...
class RegistroX305(models.AbstractModel):
    ...
    TIP_AJUST = fields.Char(
        ...
        sped_length="2",
        help=(
            "Tipo de ajustes do preço parâmetro que foram realizados: 1 - Prêmio (art. "
            "34, §7º) 2 - Prazo para pagamento (art. 34, §10, I) 3 - Quantidades "
            "negociadas (art. 34, §10, II) 4 - Influências climáticas nas "
            "características do bem exportado (art. 34, §10, III) 5 - Custos de "
            "intermediação - Custos de intermediação, nas operações de compra e venda "
            "praticadas pelas pessoas jurídicas não vinculadas, assim entendidos os "
            "custos de intermediação cobrados pelas bolsas de mercadorias e futuros "
            "internacionalmente reconhecidas (art. 34, § 10, IV). 6 - Acondicionamento "
            "(art. 34, §10, V) 7 - Frete e seguro (art. 34, §10, VI) 8 - Custos de "
            "desembarque no porto, de transporte interno, de armazenagem e de "
            "desembaraço aduaneiro, incluídos impostos e taxas incidentes na importação"
            " (art. 34, §10, VII) 9 - Prazo para pagamento (art. 22, §1º, I) 10 - "
            "Quantidades negociadas (art. 22, §1º, II) 11 - Garantia de funcionamento "
            "do bem ou da aplicabilidade do serviço ou direito (art. 22, §1º, III) 12 -"
            " Promoção do bem, serviço ou direito (art. 22, §1º, IV) 13 - Custos de "
            "fiscalização de qualidade, de padrão dos serviços e das condições de "
            "higiene (art. 22, §1º, V) 14 - Custos de intermediação (art. 22, §1º, VI) "
            "15 - Acondicionamento (art. 22, §1º, VII) 16 - Frete e seguro (art. 22, "
            "§1º, VIII) 17 - Riscos de crédito (art. 22, §1º, IX) 18 - Custos de "
            "desembarque no porto, de transporte interno, de armazenagem e de "
            "desembaraço aduaneiro, incluídos impostos e taxas incidentes na importação"
            " (art. 22, §1º, X) 19 - Similaridade (art. 24)"
        ),
    )
    ...
    DESC_OUT_AJ = fields.Char(
        ...
        help=(
            "Descrição de Outros Ajustes (X305.TIP_AJUST = “99”). Fornecer informações "
            "adicionais relativas aos ajustes efetuados e aos critérios utilizados."
        ),
    )
    ...
    FONT_AJU = fields.Char(
        ...
        required=True,
        help=(
            "Descrever a fonte que serviu para embasar o ajuste efetuado ao preço "
            "parâmetro. Por exemplo, 'o ajuste do prêmio foi realizado com base no "
            "relatório divulgado pela instituição XYZ'."
        ),
    )
...
class RegistroX310(models.AbstractModel):
    ...
    NOME = fields.Char(
        ...
        required=True,
        help=(
            "Nome: Nome ou razão social da pessoa física ou jurídica contratante da "
            "transação, que seja domiciliada no exterior."
        ),
    )
    ...
    PAIS = fields.Char(
        ...
        required=True,
        help=(
            "País: País onde a pessoa física ou jurídica contratante, no exterior, é "
            "domiciliada. Código do país, conforme tabela do Sped (Disponibilizada no "
            "programa da ECF no diretório Arquivos de Programas/Programas "
            "Sped/ECf/SpedEcf/Recursos/Tabelas)."
        ),
    )
    ...
    VL_OPER = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Valor da Operação: Valores das transações que compõem cada operação "
            "inserida no Registro X300, agrupados por pessoa física ou jurídica "
            "contratante, desde que destinadas ao mesmo país."
        ),
    )
    ...
    COND_PES = fields.Char(
        ...
        sped_length="2",
        help=(
            "Condição da Pessoa Envolvida na Operação: 01 - Considerada Vinculada. 02 -"
            " Interposta Pessoa - Transação com Vinculada. 03 - Residente/Domiciliada "
            "em País com Tributação Favorecida ou, ainda, a partir de 1º de janeiro de "
            "2009, que goze, nos termos da legislação, de regime fiscal privilegiado. "
            "04 – Considerada vinculada e Residente/Domiciliada em País com Tributação "
...
class RegistroX320(models.AbstractModel):
    ...
    TIP_IMP = fields.Char(
        ...
        sped_length="2",
        help=(
            "Tipo das Importações: 01- Bens 02- Serviços 03- Direitos 04- Operações "
            "Financeiras 05- Não Especificadas"
        ),
    )
    ...
    DESC_IMP = fields.Char(
        ...
        help=(
            "Descrição: Agrupar os bens, serviços ou direitos de mesma natureza, "
            "descrevendo cada grupo de modo a permitir a sua perfeita identificação, "
            "informando elementos como marca, tipo, modelo, espécie, etc."
        ),
    )
    ...
    TOT_OPER = fields.Float(
        ...
        help=(
            "A I O Total da Operação: IMPORTAÇÕES – Bens, Serviços ou Direitos: "
            "Informar, para cada operação incluída, o valor em reais correspondente ao "
            "total de transações de mesma natureza realizadas durante o ano-calendário."
            " São consideradas transações de mesma natureza aquelas cujos bens, "
            "serviços ou direitos negociados apresentam as mesmas especificações no "
            "campo 'Descrição'. tenção: no caso de bens considerados commodities, "
            "sujeitos à aplicação do método PCI, deve ser informado o valor de cada "
            "transação realizada, mesmo quando houver mais de uma transação envolvendo "
            "o mesmo bem. IMPORTAÇÕES – Não Especificadas: nformar neste campo o "
            "somatório das operações não informadas nos campos referentes às maiores "
            "operações ou, se for o caso, a soma do valor excedente a pelo menos 80% do"
            " total das importações, especificadas em X320.TIP_IMP como “01”, “02”, "
            "“03” ou “04”, efetuadas no ano-calendário. brigatório quando TIP_IMP = "
    ...
    COD_NCM = fields.Char(
        ...
        sped_length="8",
        help=(
            "Código NCM: Informar o código NCM constante do respectivo registro de "
            "importação, quando o tipo de operação for 'Bens'. Obrigatório somente "
            "quando TIP_IMP = Bens"
        ),
    )
    ...
    QTDE = fields.Float(
        ...
        help=(
            "Quantidade: Informar neste campo a quantidade total dos bens da mesma "
            "natureza importados (no caso de transações envolvendo commodities, o total"
            " de bens importados em cada transação realizada). Obrigatório somente "
            "quando TIP_IMP = Bens"
        ),
    )
    ...
    UNI_MED = fields.Char(
        ...
        sped_length="2",
        help=(
            "O Unidade de Medida: brigatório somente quando TIP_IMP = Bens 01 – Bilhão "
            "de Unidade Internacional 02 – Dúzia 03 – Grama 04 – Litro 05 – Megawatt "
            "Hora 06 – Metro 07 – Metro Cúbico 08 – Metro Quadrado 09 – Mil Unidades"
        ),
    )
    ...
    TIP_MET = fields.Char(
        ...
        sped_length="5",
        help=(
            "A Método: PIC00 – Preços Independentes Comparados PRL20 - Preço de Revenda"
            " Menos Lucro 20% PRL30 - Preço de Revenda Menos Lucro 30% PRL40 - Preço de"
            " Revenda Menos Lucro 40% CPL00 – Custo de Produção Mais Lucro PCI00 – "
            "Preço sob Cotação na Importação pessoa jurídica deve assinalar o método "
            "utilizado na determinação do 'Preço Parâmetro': PIC - Método dos Preços "
            "Independentes Comparados (inciso I do art. 18 da Lei nº 9.430, de 1996 e "
            "IN RFB nº 1.312, de 28 de dezembro de 2012, arts. 8 a 11); PRL 20% Método "
            "do Preço de Revenda menos Lucro (inciso III do § 12 do art. 18 da Lei nº "
            "9.430, de 1996, e IN RFB nº 1.312, de 28 de dezembro de 2012, art. 12, § "
            "10) PRL 30% Método do Preço de Revenda menos Lucro Revenda (inciso II do §"
            " 12 do art. 18 da Lei nº 9.430, de 1996 e IN RFB nº 1.312, de 28 de "
            "dezembro de 2012, art. 12, § 10); PRL 40% Método do Preço de Revenda menos"
            " Lucro Revenda (inciso I do § 12 do art. 18 da Lei nº 9.430, de 1996 e IN "
            "RFB nº 1.312, de 28 de dezembro de 2012, art. 12, § 10); CPL - Método do "
            "Custo de Produção mais Lucro (inciso III do art. 18 da Lei nº 9.430, de "
            "1996, e IN RFB nº 1.312, de 28 de dezembro de 2012, art. 15). PCI - Preço "
            "sob Cotação na Importação (art. 18-A da Lei nº 9.430, de 1996, e art. 16 "
            "da IN RFB nº 1.312, de 2012, alterado pelo art. 1º da IN RFB nº 1.395, de "
            "2013)."
        ),
    )
    ...
    COD_INV = fields.Char(
        ...
        sped_length="6",
        help=(
            "Código de Inventário do Insumo ou Produto Importado: Informar o código de "
            "inventário do insumo ou produto importado, . Caso um determinado insumo ou"
            " produto tenha mais de um código, informar o mais relevante em termos "
            "quantitativos."
        ),
    )
    ...
    UTIL_INS_PROD = fields.Char(
        ...
        sped_length="2",
        help=(
            "Utilização do Insumo ou Produto Importado: Descrição da utilização do "
            "insumo ou produto importado: informar a destinação do insumo ou produto "
            "importado, dentre as seguintes opções: RV – Revenda IN – Industrialização"
        ),
    )
    ...
    OPER_PAR = fields.Char(
        ...
        sped_length="1",
        help=(
            "Operações para a Apuração do Preço Parâmetro: Informar que tipo de "
            "operações foram selecionadas para a apuração do preço parâmetro, dentre as"
            " seguintes opções (art. 8º, parágrafo único, da IN 1.312/2012): E – "
            "operações realizadas entre a mesma pessoa jurídica exportadora e pessoas "
            "jurídicas não vinculadas. C – operações realizadas entre o próprio "
            "contribuinte e pessoas jurídicas não vinculadas. T – operações realizadas "
            "entre terceiros não vinculados entre si."
        ),
    )
    ...
    DESC_PAR = fields.Char(
        ...
        help=(
            "Itens Selecionados para a Apuração do Preço Parâmetro: Descrição dos bens,"
            " serviços ou direitos idênticos ou similares selecionados para o cálculo "
            "do preço parâmetro nas operações utilizadas para a apuração do preço "
            "parâmetro (informar dados como nome, razão social, número de identificação"
            " e país de residência)."
        ),
    )
    ...
    ID_PARTE_PAR = fields.Char(
        ...
        help=(
            "Identificação das Partes Envolvidas: Identificação das partes envolvidas "
            "nas operações de exportação utilizadas e informadas no campo X320.OPER_PAR"
            " (informar nome, razão social e número de identificação)."
        ),
    )
    ...
    DAT_UTIL = fields.Date(
        ...
        sped_length="1",
        help=(
            "T C A Data Utilizada no Cálculo do Preço Parâmetro: Data da cotação "
            "utilizada para o cálculo do preço parâmetro, podendo ser a data da "
            "transação (conforme dispõe o § 2º-A, art 16, da Instrução Normativa RFB nº"
            " 1312/2012). Escolher entre as seguintes opções: – Data da Transação - "
            "preço negociado (art. 16, §15) O - Data da Transação - média de dias "
            "evento (art. 16, §16) E – Data do Embarque aso escolhida a opção 'T - Data"
            " da Transação', deverá ser informado no campo 18 'DAT_TRANS' a data em que"
            " o preço foi negociado, conforme art. 16, §15 da Instrução Normativa RFB "
            "nº 1.312/2012. opção 'O - Data da Transação (art. 16, §16) deve ser "
            "escolhida caso o contribuinte utilize"
        ),
    )
    ...
    CRIT_PAR = fields.Char(
        ...
        help=(
            ...
            "os critérios utilizados para fixação do preço, relatando, inclusive, a "
            "existência de diferenças entre a data em que a operação foi contratada e "
            "aquela em que o preço foi estabelecido."
        ),
    )
    ...
    DAT_TRANS = fields.Date(
        ...
        help=(
            "Data da Transação: Informar a data em que o preço foi negociado (conforme "
            "art.16, §15 da Instrução Normativa RFB nº 1.312/2012)."
        ),
    )
    ...
    DAT_DUIMP = fields.Date(
        ...
        sped_length="8",
        help=(
            "Data do registro da Declaração Única de Importação (DUIMP): Informar a "
            "data do registro da DUIMP da commodity negociada."
        ),
    )
    ...
    ID_FONT_COT = fields.Char(
        ...
        sped_length="3",
        help=(
            "1 Fonte da Cotação: Descrição da fonte utilizada para a busca do preço "
            "parâmetro informado em VL_PAR (indicação da bolsa de mercadorias e futuros"
            " utilizada, dentre as listadas no Anexo II da Instrução Normativa RFB nº "
            "1.312/2012, ou da instituição de pesquisa setorial, dentre as listadas no "
            "Anexo III da referida Instrução Normativa). 01 ChicagoBoard of Trade "
            "(CBOT) - Chicago - EUA; 102 Chicago Mercantile Exchange (CME) - Chicago - "
            "EUA; 103 New York Mercantile Exchange (NYMEX) - Nova York - EUA; 104 "
            "Commodity Exchange (COMEX) - Nova York - EUA; 105 Intercontinental "
            "Exchange (ICE US) - Atlanta - EUA; 106 Bolsa de Mercadorias & Futuros "
            "(BM&F) - São Paulo - Brasil; 107 Life NYSE Euronext (LIFFE) - Londres - "
            "Reino Unido; 108 London Metal Exchange (LME) - Londres - Reino Unido; 109 "
            "Intercontinental Exchange (ICE Europe) - Londres - Reino Unido; 110 Tokio "
            "Commodity Exchange (TOCOM) - Tóquio - Japão; 111 Tokio Grain Exchange "
            "(TGE) - Tóquio - Japão; 112 Singapore Commodity Exchange (SICOM) - Cidade "
            "de Cingapura - Cingapura; 113 Hong Kong Commodity Exchange (HKE) - Hong "
            "Kong – China; 114 Multi Commodity Exchange (MCX) - Bombain - Índia; 115 "
            "National Commodity & Derivatives Exchange Limited (NCDEX) - Bombain - "
            "Índia; 116 Agricultural Futures Exchange of Thailand (AFET) - Bangkok - "
            "Tailândia; 117 Australian Securities Exchange (ASX) - Sidney - Austrália; "
            "118 JSE Safex APD (SAFEX) – Johannesburg - África do Sul; 119 Korea "
            "Exchange (KRX) - Busan - Coréia do Sul; 120 China Beijing International "
            "Mining Exchange, (CBMX); 121 GlobalORE; 122 London Bullion Market "
            "Association (LBMA); 123 Beijing Iron Ore Trading Center Corporation "
            "(COREX). (Incluído pela IN RFB nº 1.870/2019) 201 PLATTS; 202 ARGUS; 203 "
            "CMA; 204 ESALQ;"
        ),
    )
    ...
    AJ_PAR = fields.Char(
        ...
        sped_length="1",
        help=(
            "S Ajustes do Preço Parâmetro: Ajustes do preço parâmetro: informar se "
            "foram realizados ajustes ao preço parâmetro, conforme disposto nos art. "
            "9º; 10; 11, §1º; 15, §7; e 16, §9º da Instrução Normativa RFB nº "
            "1.312/2012, a depender do método aplicado. – Sim N - Não"
        ),
    )
    ...
    VL_PAR = fields.Monetary(
        ...
        help=(
            "Preço Parâmetro: A pessoa jurídica deve informar neste campo o preço "
            "parâmetro médio ponderado de aquisição nas importações dos bens, serviços "
            "ou direitos, apurado no ano- calendário conforme um os métodos "
            "estabelecidos nos arts. 8º a 19 da Instrução Normativa RFB nº 1.312, de 28"
            " de dezembro de 2012. Atenção: nos casos de utilização do método PCI, o "
            "valor a ser informado é o preço parâmetro apurado para cada transação "
            "realizada. Obrigatório somente quando TIP_IMP = Bens, Serviços ou Direitos"
        ),
    )
    ...
    VL_PRAT = fields.Monetary(
        ...
        help=(
            "Preço Praticado: A pessoa jurídica deve informar neste campo o preço "
            "praticado médio ponderado de aquisição nas importações dos bens, serviços "
            "ou direitos, praticado no ano- calendário. Atenção: nos casos de "
            "utilização do método PCI, o valor a ser informado é o preço praticado "
            "apurado para cada transação realizada. Obrigatório somente quando TIP_IMP "
    ...
    QTDE_AJ = fields.Float(
        ...
        help=(
            "Quantidade Ajustada no Período de Apuração: Informar neste campo a "
            "quantidade de itens da mesma natureza importados de pessoas vinculadas que"
            " resultaram em ajustes de preços de transferência adicionados à base de "
            "cálculo do IRPJ e da CSLL no período de apuração. Ou seja, a quantidade de"
            " bens ou insumos para os quais se verificou a necessidade de ajuste de "
            "preços de transferência após a aplicação de um dos métodos previstos na "
            "legislação para o cálculo do preço parâmetro e sua comparação com o preço "
            "praticado."
        ),
    ...
    VL_AJ = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Valor do Ajuste a Ser Adicionado: Valor do ajuste, determinado conforme os"
            " métodos da IN RFB nº 1.312/2012. a ser adicionado à base de cálculo do "
            "IRPJ e da CSLL. A) IMPORTAÇÕES – Bens, Serviços ou Direitos A pessoa "
            "jurídica deve indicar o valor do ajuste, determinado em conformidade com "
            "os arts. 4º a 7º da Instrução Normativa RFB nº 1.312, de 28 de dezembro de"
            " 2012. Quando se tratar de encargos de depreciação ou amortização dos bens"
            " e direitos, a"
        ),
    )
    ...
    VALOR_COT = fields.Monetary(
        ...
        help=(
            ...
            "importado (art. 16 da IN RFB 1.312/2012) utilizada no cálculo do preço "
            "parâmetro, sem a inclusão de eventuais ajustes efetuados, em reais, e na "
    ...
    VL_JUR = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Juros: Informar em reais o valor total dos juros pagos ou creditados em "
            "operações financeiras durante o ano-calendário. Esse valor total deve ser "
            "consolidado consoante os códigos de natureza-fato de operação constantes "
            "da Consolidação das Normas Cambiais (CNC), editada pelo Banco Central do "
            "Brasil."
        ),
    ...
    COD_CNC = fields.Char(
        ...
        sped_length="5",
        help=(
            "C Código CNC, conforme tabela do Sped (Disponibilizada no programa da ECF "
            "no diretório Arquivos de Programas/Programas "
            "Sped/ECf/SpedEcf/Recursos/Tabelas). ódigo CNC: Código da natureza-fato "
            "específico correspondente à motivação do recebimento/pagamento, conforme §"
            " 1o do artigo 23 da Lei no 4.131, de 03 de setembro de 1962, e que consta "
            "na Circular no 3.690, de 16 de dezembro de 2013, do Banco Central do "
            "Brasil. Atenção: No caso dos recursos não terem sido enviados ao exterior,"
            " o enquadramento se faz, consoante apuração contábil, como se remetidos "
            "fossem. Tendo ocorrido a efetiva remessa, esses valores são de igual modo "
            "classificados, independentemente do instrumento de formalização cambial "
            "utilizado no Banco Central do Brasil - contrato de câmbio e/ou "
            "transferência internacional em moeda nacional. Obrigatório apenas para "
            "TIP_IMP = Operações Financeiras Observação: O registro X320 não possui "
            "informação de data em seus campos. Portanto, os códigos utilizados no "
            "campo X320.COD_CNC devem ser os vigentes na data final da ECF, para todas "
            "as operações ocorridas durante o ano da escrituração."
        ),
    )
    ...
    TIP_MOEDA = fields.Char(
        ...
        sped_length="3",
        help=(
            "Moeda: a pessoa jurídica deve selecionar, dentre as opções, a moeda de "
            "negociação. Obrigatório apenas para TIP_IMP=Operações Financeiras"
        ),
    )
...
class RegistroX325(models.AbstractModel):
    ...
    TIP_AJUST = fields.Char(
        ...
        help=(
            "Tipo de ajustes do preço parâmetro que foram realizados: 1 - Prêmio (art. "
            "16, §6º) 2 - Prazo para pagamento (art. 16, §9º, I) 3 - Quantidades "
            "negociadas (art. 16, §9º, II) 4 - Influências climáticas nas "
            "características do bem exportado (art. 16, §9º, III) 5 - Custos de "
            "intermediação - Custos de intermediação, nas operações de compra e venda "
            "praticadas pelas pessoas jurídicas não vinculadas, assim entendidos os "
            "custos de intermediação cobrados pelas bolsas de mercadorias e futuros "
            "internacionalmente reconhecidas (art. 34, § 10, IV). 6 - Acondicionamento "
            "(art. 16, §9º, V) 7 - Frete e seguro (art. 16, §9º, VI) 8 - Custos de "
            "desembarque no porto, de transporte interno, de armazenagem e de "
            "desembaraço aduaneiro, incluídos impostos e taxas incidentes na importação"
            " (art. 16, §9º, VII) 9 - Prazo para pagamento (art. 9, §1º, I) 10 - "
            "Quantidades negociadas (art. 9, §1º, II) 11 - Garantia de funcionamento do"
            " bem ou da aplicabilidade do serviço ou direito (art. 9, §1º, III) 12 - "
            "Promoção do bem, serviço ou direito (art. 9, §1º, IV) 13 - Custos de "
            "fiscalização de qualidade, de padrão dos serviços e das condições de "
            "higiene (art. 9, §1º, V) 14 - Custos de intermediação (art. 9, §1º, VI) 15"
            " - Acondicionamento (art. 9, §1º, VII) 16 - Frete e seguro (art. 9, §1º, "
            "VIII) 17 - Custos de desembarque no porto, de transporte interno, de "
            "armazenagem e de desembaraço aduaneiro, incluídos impostos e taxas "
            "incidentes na importação (art. 9, §1º, IX) 18 - Similaridade (art. 10) 19 "
            "- Variação cambial (art. 24)"
        ),
    )
    ...
    DESC_OUT_AJ = fields.Char(
        string="Descrição de Outros Ajustes",
        help=(
            "Descrição de Outros Ajustes (X325.TIP_AJUST = “99”). Fornecer informações "
            "adicionais relativas aos ajustes efetuados e aos critérios utilizados."
        ),
    )
...
class RegistroX330(models.AbstractModel):
    ...
    VL_OPER = fields.Monetary(
        ...
        help=(
            "Valor da Operação: Valores das transações que compõem cada operação "
            "inserida no registro X320, agrupados por pessoa física ou jurídica "
            "contratante, desde que originadas do mesmo país."
        ),
    )
...
class RegistroX340(models.AbstractModel):
    ...
    IND_CONTROLE = fields.Char(
        ...
        help=(
            ...
            "(art. 19-A da Instrução Normativa RFB no 1.520/2014)."
        ),
    )
    ...
    MOT_NAO_CONSOL = fields.Integer(
        ...
        help=(
            ...
            "22; 5 – Controlada, direta ou indiretamente, por pessoa jurídica submetida"
...
class RegistroX420(models.AbstractModel):
    ...
    TIP_ROY = fields.Char(
        ...
        sped_length="1",
        help=(
            "Indicar se são roylaties recebidos ou pagos a benfeciários no Brasil e no "
...
class RegistroX450(models.AbstractModel):
    ...
    VL_SERV_ASSIST = fields.Monetary(
        ...
        help=(
            "Valor dos Serviços de Assistência Técnica, Científica, Administrativa e "
            "Assemelhados com Transferência de Tecnologia: Pagamentos ou as remessas "
            "efetuados a título de serviços de assistência técnica, científica, "
            "administrativa e assemelhados referentes aos contratos que, em "
            "conformidade com a Lei nº 9.279, de 14 maio de 1996, estipulam as "
            "condições de obtenção de técnicas, métodos de planejamento e programação, "
            "bem como pesquisas, estudos e projetos destinados à execução ou prestação "
            "de serviços especializados e que tenham sido objeto de registro no "
    ...
    VL_SERV_SEM_ASSIST = fields.Monetary(
        ...
        help=(
            "Valor dos Serviços Técnicos e de Assistência sem Transferência de "
            "Tecnologia Prestados no Brasil: Valores pagos a título de serviços "
            "técnicos e de assistência, prestados no Brasil, referentes aos contratos "
            "dispensados de averbação no Instituto Nacional de Propriedade Industrial "
            "(INPI) por não constituírem transferência de tecnologia, tais como: i) "
            "Agenciamento de compras, inclusive serviços de logística relativos ao "
    ...
    VL_SERV_SEM_ASSIST_EXT = fields.Monetary(
        ...
        help=(
            "Valor dos Serviços Técnicos e de Assistência sem Transferência de "
            "Tecnologia Prestados no Exterior: Vaolres pagos a título de serviços "
            "técnicos e de assistência, prestados no Brasil, referentes aos contratos "
            "dispensados de averbação no Instituto Nacional de Propriedade Industrial "
            "(INPI) por não constituírem transferência de tecnologia, tais como: i) "
            "Agenciamento de compras, inclusive serviços de logística relativos ao "
    ...
    VL_JURO_PF = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Valor dos Juros sobre o Capital Próprio Pagos a Pessoa Física: Valor pago "
            "ou remetido à pessoa física residente ou domiciliada no Brasil ou no "
            "exterior a título de remuneração dos recursos investidos na pessoa "
            "jurídica declarante, de que trata o art. 9º da Lei nº 9.249, de 26 de "
            "dezembro de 1995. Atenção: 1) Não informar neste campo o valor "
            "correspondente aos juros pagos ou remetidos durante o período que "
            "anteceder o início das operações sociais ou de implantação do "
            "empreendimento inicial de que trata a alínea “b” do parágrafo 1º do art. "
            "15 do Decreto-Lei nº 1.598, de 26 de dezembro de 2012. 2) As cooperativas "
            "não devem informar neste campo o valor relativo aos juros pagos aos "
            "associados correspondente à remuneração de até 12% sobre o capital "
            "integralizado de que trata o parágrafo único do art. 49 da Lei nº 4.506, "
            "de 30 de novembro de 1964, c/c parágrafo 3º do art. 24 da Lei nº 5.764, de"
            " 16 de dezembro de 1971, e o art. 357 do Decreto nº 9.580/2018."
        ),
    )
    ...
    VL_JURO_PJ = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Valor dos Juros sobre o Capital Próprio Pagos a Pessoa Jurídica: Valor "
            "pago ou remetido pela pessoa jurídica a outra pessoa jurídica domiciliada "
            "no Brasil ou no exterior a título de remuneração dos recursos investidos "
            "na pessoa jurídica declarante, de que trata o art. 9º da Lei nº 9.249, de "
    ...
    VL_DEMAIS_JUROS = fields.Monetary(
        ...
        help=(
            ...
            "decorrentes da remuneração de empréstimos tomados pela pessoa jurídica no "
            "Brasil ou no exterior por meio de contratos de financiamento e de mútuo "
            "registrados ou não no Banco Central do Brasil. Também deve ser informado "
            "neste campo o valor correspondente aos: - juros pagos ou remetidos durante"
            " o período que anteceder o início das operações sociais ou de implantação "
            "do empreendimento inicial de que trata a alínea “b” do parágrafo 1º do "
            "art. 15 do Decreto-Lei nº 1.598, de 26 de dezembro de 2012; - juros pagos "
            "ou remetidos por cooperativa à pessoa jurídica associada correspondentes à"
            " remuneração de até 12% sobre o capital integralizado, de que trata o "
            "parágrafo único do art. 49 da Lei nº 4.506, de 30 de novembro de 1964, c/c"
            " parágrafo 3º do art. 24 da Lei nº 5.764, de 16 de dezembro de 1971, e o "
            "art. 357 do Decreto nº 9.580/2018; - juros pagos ou remetidos "
            "correspondentes a quaisquer transações realizadas pela pessoa jurídica. "
            "Atenção: O valor de juros pago ou remetido em decorrência da Resolução "
            "Bacen nº 3.844, de 23 de março de 2010, também deve ser informado neste "
            "campo, exceto se referir-se ao pagamento ou remessa de juros de capital "
    ...
    VL_DIVID_PF = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Dividendos Pagos a Pessoa Física: Valor dos lucros ou dividendos pagos ou "
            "remetidos pela pessoa jurídica à pessoa física residente ou domiciliada no"
            " Brasil ou no exterior em decorrência de participação societária avaliada "
            "pelo método da equivalência patrimonial ou pelo custo de aquisição."
        ),
    )
    ...
    VL_DIVID_PJ = fields.Monetary(
        ...
        currency_field="brl_currency_id",
        help=(
            "Dividendos Pagos a Pessoa Jurídica: Valor dos lucros ou dividendos pagos "
            "ou remetidos pela pessoa jurídica a outra pessoa jurídica domiciliada no "
            "Brasil ou no exterior em decorrência de participação societária avaliada "
            "pelo método da equivalência patrimonial ou pelo custo de aquisição."
        ),
    )
...
class RegistroY720(models.AbstractModel):
    ...
    LUC_LIQ = fields.Float(
        ...
        help=(
            ...
            "1o do art. 6o da Instrução Normativa RFB no 1.422, de 19 de dezembro de "
            "2013, com redação dada pela Instrução Normativa RFB no 1.574, de 24 de "
            "julho de 2014, na aplicação da multa de que trata o caput, quando não "
...
class RegistroY800(models.AbstractModel):
    ...
    TIPO_DOC = fields.Char(
        ...
        sped_length="3",
        help=(
            "Tipo do Documento: 001 - Memória de Cálculo - Incoporação 002 - Laudo de "
